                        ...
                        <div className="col-xs-6">
                            <ul className="list-inline top-right-nav">
                                ...
                                <li className="dropdown">
                                    <a href="javascript: void(0);" className="right-sidebar-toggle"><i
                                ...
                                <li className="dropdown avtar-dropdown">
                                    ...
                                    <ul className="dropdown-menu top-dropdown">
                                        ...
                                        <li><a href="javascript: void(0);"><i className="icon-bell"></i> Activities</a></li>
                                        <li><a href="javascript: void(0);"><i className="icon-user"></i> Profile</a></li>
                                        <li><a href="javascript: void(0);"><i className="icon-settings"></i> Settings</a></li>
                                        <li className="divider"></li>
                                        <li><a href="javascript: void(0);"><i className="icon-logout"></i> Logout</a></li>
                                    </ul>
                                </li>
